...
<footer class="bg-white dark:bg-dark" aria-labelledby="footer-heading">
   ...
   <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
     ...
     <div class="mt-12 border-t border-gray-200 dark:border-gray-500 pt-8">
       <p class="text-base text-gray-400 xl:text-center">&copy; 2022 Akane Digital. Todos los derechos reservados</p>
     </div>
   </div>
 </footer>
